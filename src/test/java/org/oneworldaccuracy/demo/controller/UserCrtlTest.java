...
class UserCrtlTest {
    ...
    @Test
    void shouldThrow404ErrorWhenUserToFetchDoesNotExist() throws Exception {
    ...
    @Test
    void shouldThrowBadRequestErrorWhenWeTryToRegisterUserWithExistingId() throws Exception {
        int databaseSizeBeforeCreate = userRepository.findAll().size();

        UserRegistrationDTO registerUser = new UserRegistrationDTO();
        registerUser.setId(123L);
        registerUser.setTitle(DEFAULT_TITLE);
        registerUser.setFirstName(DEFAULT_FIRSTNAME);
        registerUser.setLastName(DEFAULT_LASTNAME);
        registerUser.setEmail(DEFAULT_EMAIL);
    ...
    @Test
    void shouldThrowBadRequestErrorWhenWeTryToRegisterUserWithExistingEmail() throws Exception {
        User user = createUser();
        user = userRepository.saveAndFlush(user);
    ...
    @Test
    void shouldThrowBadRequestErrorWhenWeTryToUpdatingUserWithExistingEmail() throws Exception {
        User user = createUser();
        user = userRepository.saveAndFlush(user);
    ...
    @Test
    void shouldThrow404ErrorWhenUserToUpdateDoesNotExist() throws Exception {
    ...
    @Test
    void shouldDeactivateExistingUser() throws Exception {
        User user = createUser();
        user = userRepository.saveAndFlush(user);
    ...
    @Test
    void shouldThrow404ErrorWhenUserToDeleteDoesNotExist() throws Exception {
    ...
    @Test
    void shouldThrowBadRequestIfActivationKeyDoesNotExists() throws Exception {
        User user = createUser();
          String activationKey = RandomStringUtils.randomAlphabetic(20);
        user.setEmail("activate-user@local.host");
        user.setActivationKey(activationKey);
